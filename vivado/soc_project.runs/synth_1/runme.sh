...
HD_PWD='/home/adadek/workspace/SoC_Design/vivado/soc_project.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log soc_project_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source soc_project_wrapper.tcl
