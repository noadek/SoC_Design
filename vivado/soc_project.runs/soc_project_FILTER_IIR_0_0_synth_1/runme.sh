...
HD_PWD='/home/adadek/SoC_Design/vivado/soc_project.runs/soc_project_FILTER_IIR_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log soc_project_FILTER_IIR_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source soc_project_FILTER_IIR_0_0.tcl
