...
HD_PWD='/home/adadek/workspace/SoC_Design/vivado/soc_project.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log soc_project_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source soc_project_wrapper.tcl -notrace
